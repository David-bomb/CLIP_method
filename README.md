...
> **Примечание про Threshold (порог):** Порог был взят маленький в силу особенности SigLIP, так как в нем вместо softmax используется Sigmoid. Подробнее про это можно посмотреть в виде <a href="https://github.com/David-bomb/CLIP_method/blob/main/additional/CLIP_meme.jpg">мема</a>, а также в виде <a href="https://habr.com/ru/articles/908168/">статьи</a>. 
